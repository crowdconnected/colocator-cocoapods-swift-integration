...
@property (nonatomic, weak) id <CCLocationDelegate> _Nullable delegate;
...
- (void)setAliasesWithAliases:(NSDictionary<NSString *, NSString *> * _Nonnull)aliases SWIFT_DEPRECATED_MSG("Replaced by addAlias(key, value) method");
- (void)addAliasWithKey:(NSString * _Nonnull)key value:(NSString * _Nonnull)value;
+ (void)askMotionPermissions SWIFT_DEPRECATED_MSG("Replaced by triggerMotionPermissionPopUp() method");
...
SWIFT_PROTOCOL("_TtP10CCLocation18CCLocationDelegate_")
@protocol CCLocationDelegate
...
SWIFT_CLASS("_TtC10CCLocation16LocationResponse")
